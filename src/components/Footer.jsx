...
const VimeoIcon = ({ size = 14 }) => (
  <img
    src="/images/softwarelogo/vimeologo.png"
    alt="Vimeo"
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-4 md:gap-8">
            ...
            <a href="https://vimeo.com/user259920366?fl=pp&fe=sh" target="_blank" rel="noopener noreferrer" className="text-cinematic-muted hover:text-white transition-colors duration-300 flex items-center gap-2 group">
              <span className="w-8 h-8 rounded-full border border-cinematic-gray flex items-center justify-center group-hover:border-cinematic-accent transition-colors duration-300">
                <VimeoIcon size={14} />
              </span>
              <span className="text-xs uppercase tracking-widest sr-only md:not-sr-only md:inline-block">Vimeo</span>
            </a>
